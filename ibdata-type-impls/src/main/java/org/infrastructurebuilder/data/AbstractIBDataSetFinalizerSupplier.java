...
public abstract class AbstractIBDataSetFinalizerSupplier<T>
    extends AbstractIBDataConfigurableFactory<IBDataSetFinalizer<T>> implements IBDataSetFinalizerSupplier<T> {

  protected AbstractIBDataSetFinalizerSupplier(IBRuntimeUtils ibr) {
    super(ibr);
  }
