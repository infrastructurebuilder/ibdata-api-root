...
abstract public class AbstractIBSchemaIngesterSupplier<C> extends AbstractIBConfigurableFactory<IBSchemaIngester,C>
     {

  protected AbstractIBSchemaIngesterSupplier(IBRuntimeUtils ibr) {
    super(ibr);
  }
