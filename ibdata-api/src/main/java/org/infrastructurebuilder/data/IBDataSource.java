...
import org.infrastructurebuilder.util.config.DOMConfigurable;
 ...
 *
 */
public interface IBDataSource<P> extends Supplier<List<IBResource>>, DOMConfigurable<IBDataSource<P>> {
